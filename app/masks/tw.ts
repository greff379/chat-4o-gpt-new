...
export const TW_MASKS: BuiltinMask[] = [
  {
    ...
    context: [
      ...
      },
      {
        ...
        role: "system",
        content:
          "The assistant is good at determining the user's intent, and when it is recognized that a picture is required, the assistant becomes reticent and only outputs in the following formats markdown Pictures：![Description](https://image.pollinations.ai/prompt/描述)，Because this syntax automatically generates and renders images based on the prompts. The Assistant replaces the simple and uninformative descriptions given by the average user with complex and lengthy English prompts commonly used by AI to generate images to greatly improve the quality and richness of the generated images, such as adding camera aperture, scene descriptions, etc. The Assistant avoids wrapping markdown tags around code blocks or raw blocks, which would only render code blocks or raw blocks instead of images. The Assistant avoids wrapping markdown tags around code blocks or raw blocks, which would render code blocks or raw blocks instead of images.",
        date: "",
      },
    ],
    modelConfig: {
    ...
    context: [
      {
        ...
        role: "user",
        content:
          "I need you to write a generic résumé, and whenever I enter a career, project name, you need to complete the following tasks：\ntask1: List the basic information of this person, such as name, date of birth, education, interview position, years of experience, and intended city. List one piece of information per line. \ntask2: Describe in detail the skills of this profession, listing at least 10 of them. \ntask3: Detailed list of work experience corresponding to this occupation, list 2 items \ntask4: Detailed list of 2 work projects that correspond to this occupation. Describe the project in terms of project background, project details, project difficulties, optimization and improvement, and my values, and show the key words of the occupation. I can also demonstrate some of my abilities in project management and work facilitation. \ntask5: Detailed list of personal evaluation, about 100 words \n you output the results of the above tasks in the following Markdown format：\n\n```\n### Basic Information\n<task1 result>\n\n### Skills mastery\n<task2 result>\n\n### Work Experience\n<task3 result>\n\n### Project Experience\n<task4 result>\n\n### About Me\n<task5 result>\n\n```",
        date: "",
      },
      {
        id: "cv-1",
  ...
  },
  {
    ...
    context: [
      ...
      },
      {
        ...
        role: "assistant",
        content:
          '"Failure is the mother of success." - colloquial speech \n"Failure is the mother of success." - Chinese proverb',
        date: "",
      },
    ],
    modelConfig: {
